...
("testuser0", "123456", 0, now(), "127.0.0.1", now()),
("testuser1", "123456", 0, now(), "127.0.0.1", now()),
("testuser2", "123456", 0, now(), "127.0.0.1", now()),
("testuser3", "123456", 0, now(), "127.0.0.1", now()),
("testuser4", "123456", 0, now(), "127.0.0.1", now()),
("testuser5", "123456", 0, now(), "127.0.0.1", now()),
("testuser6", "123456", 0, now(), "127.0.0.1", now()),
("testuser7", "123456", 0, now(), "127.0.0.1", now()),
("testuser8", "123456", 0, now(), "127.0.0.1", now()),
("testuser9", "123456", 0, now(), "127.0.0.1", now());